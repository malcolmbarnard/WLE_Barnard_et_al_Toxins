...
elseif z == 2
    ...
    subplot(3,2,2)
    hold on
    h13 = plot(d,Chl_A_S_Control,'-o','color',[0 0 0],'markerfacecolor',[0 0 0]);
    h14 = plot(d,Chl_A_S_NO3,'-x','color',[0.9 0.6 0],'markerfacecolor',[0.9 0.6 0]);
    h15 = plot(d,Chl_A_S_NH4,'-+','color',[0.35 0.7 0.9],'markerfacecolor',[0.35 0.7 0.9]);
    h16 = plot(d,Chl_A_S_UREA,'-*','color',[0 0.45 0.70],'markerfacecolor',[0 0.45 0.70]);
    h17 = plot(d,Chl_A_S_PO4,'-d','color',[0 0.6 .5],'markerfacecolor',[0 0.6 .5]);
    h18 = plot(d,Chl_A_S_NP,'-s','color',[0.8 0.4 0],'markerfacecolor',[0.8 0.4 0]);
    ...
    subplot(3,2,3)
    hold on
    h7 = plot(d,Chl_A_M_D_Control,'-o','color',[0 0 0],'markerfacecolor',[0 0 0]);
    h8 = plot(d,Chl_A_M_D_NO3,'-x','color',[0.9 0.6 0],'markerfacecolor',[0.9 0.6 0]);
    h9 = plot(d,Chl_A_M_D_NH4,'-+','color',[0.35 0.7 0.9],'markerfacecolor',[0.35 0.7 0.9]);
    h10 = plot(d,Chl_A_M_D_UREA,'-*','color',[0 0.45 0.70],'markerfacecolor',[0 0.45 0.70]);
    h11 = plot(d,Chl_A_M_D_PO4,'-d','color',[0 0.6 .5],'markerfacecolor',[0 0.6 .5]);
    h12 = plot(d,Chl_A_M_D_NP,'-s','color',[0.8 0.4 0],'markerfacecolor',[0.8 0.4 0]);
    ...
    subplot(3,2,4)
    hold on
    h19 = plot(d,Chl_A_S_D_Control,':o','color',[0 0 0],'markerfacecolor',[0 0 0]);
    h20 = plot(d,Chl_A_S_D_NO3,':x','color',[0.9 0.6 0],'markerfacecolor',[0.9 0.6 0]);
    h21 = plot(d,Chl_A_S_D_NH4,':+','color',[0.35 0.7 0.9],'markerfacecolor',[0.35 0.7 0.9]);
    h22 = plot(d,Chl_A_S_D_UREA,'-*','color',[0 0.45 0.70],'markerfacecolor',[0 0.45 0.70]);
    h23 = plot(d,Chl_A_S_D_PO4,':d','color',[0 0.6 .5],'markerfacecolor',[0 0.6 .5]);
    h24 = plot(d,Chl_A_S_D_NP,':s','color',[0.8 0.4 0],'markerfacecolor',[0.8 0.4 0]);
...
elseif z == 3
    ...
    subplot(3,2,2)
    hold on
    h1 = plot(d,MCC_J_S_Control,'-o','color',[0 0 0],'markerfacecolor',[0 0 0]);
    h2 = plot(d,MCC_J_S_NO3,'-x','color',[0.9 0.6 0],'markerfacecolor',[0.9 0.6 0]);
    h3 = plot(d,MCC_J_S_NH4,'-+','color',[0.35 0.7 0.9],'markerfacecolor',[0.35 0.7 0.9]);
    h4 = plot(d,MCC_J_S_PO4,'-d','color',[0 0.6 .5],'markerfacecolor',[0 0.6 .5]);
    h5 = plot(d,MCC_J_S_NP,'-s','color',[0.8 0.4 0],'markerfacecolor',[0.8 0.4 0]);
    ...
    subplot(3,2,4)
    hold on
    h7 = plot(d,MCC_J_S_D_Control,':o','color',[0 0 0],'markerfacecolor',[0 0 0]);
    h8 = plot(d,MCC_J_S_D_NO3,':x','color',[0.9 0.6 0],'markerfacecolor',[0.9 0.6 0]);
    h9 = plot(d,MCC_J_S_D_NH4,':+','color',[0.35 0.7 0.9],'markerfacecolor',[0.35 0.7 0.9]);
    h11 = plot(d,MCC_J_S_D_PO4,':d','color',[0 0.6 .5],'markerfacecolor',[0 0.6 .5]);
    h12 = plot(d,MCC_J_S_D_NP,':s','color',[0.8 0.4 0],'markerfacecolor',[0.8 0.4 0]);
...
elseif z == 4
    ...
    subplot(3,2,2)
    hold on
    h7 = plot(d,MCC_A_M_Control,':o','color',[0 0 0],'markerfacecolor',[0 0 0]);
    h8 = plot(d,MCC_A_M_NO3,':x','color',[0.9 0.6 0],'markerfacecolor',[0.9 0.6 0]);
    h9 = plot(d,MCC_A_M_NH4,':+','color',[0.35 0.7 0.9],'markerfacecolor',[0.35 0.7 0.9]);
    h10 = plot(d,MCC_A_M_UREA,':*','color',[0 0.45 0.70],'markerfacecolor',[0 0.45 0.70]);
    h11 = plot(d,MCC_A_M_PO4,':d','color',[0 0.6 .5],'markerfacecolor',[0 0.6 .5]);
    h12 = plot(d,MCC_A_M_NP,':s','color',[0.8 0.4 0],'markerfacecolor',[0.8 0.4 0]);
    ...
    subplot(3,2,4)
    hold on
    h7 = plot(d,MCC_A_M_D_Control,':o','color',[0 0 0],'markerfacecolor',[0 0 0]);
    h8 = plot(d,MCC_A_M_D_NO3,':x','color',[0.9 0.6 0],'markerfacecolor',[0.9 0.6 0]);
    h9 = plot(d,MCC_A_M_D_NH4,':+','color',[0.35 0.7 0.9],'markerfacecolor',[0.35 0.7 0.9]);
    h10 = plot(d,MCC_A_M_D_UREA,':*','color',[0 0.45 0.70],'markerfacecolor',[0 0.45 0.70]);
    h11 = plot(d,MCC_A_M_D_PO4,':d','color',[0 0.6 .5],'markerfacecolor',[0 0.6 .5]);
    h12 = plot(d,MCC_A_M_D_NP,':s','color',[0.8 0.4 0],'markerfacecolor',[0.8 0.4 0]);
...
elseif z == 5
    ...
    subplot(3,2,2)
    hold on
    h1 = plot(d,ATXC_J_S_Control,'-o','color',[0 0 0],'markerfacecolor',[0 0 0]);
    h2 = plot(d,ATXC_J_S_NO3,'-x','color',[0.9 0.6 0],'markerfacecolor',[0.9 0.6 0]);
    h3 = plot(d,ATXC_J_S_NH4,'-+','color',[0.35 0.7 0.9],'markerfacecolor',[0.35 0.7 0.9]);
    h5 = plot(d,ATXC_J_S_PO4,'-d','color',[0 0.6 .5],'markerfacecolor',[0 0.6 .5]);
    h6 = plot(d,ATXC_J_S_NP,'-s','color',[0.8 0.4 0],'markerfacecolor',[0.8 0.4 0]);
    ...
    subplot(3,2,4)
    hold on
    h7 = plot(d,ATXC_J_S_D_Control,':o','color',[0 0 0],'markerfacecolor',[0 0 0]);
    h8 = plot(d,ATXC_J_S_D_NO3,':x','color',[0.9 0.6 0],'markerfacecolor',[0.9 0.6 0]);
    h9 = plot(d,ATXC_J_S_D_NH4,':+','color',[0.35 0.7 0.9],'markerfacecolor',[0.35 0.7 0.9]);
    h11 = plot(d,ATXC_J_S_D_PO4,':d','color',[0 0.6 .5],'markerfacecolor',[0 0.6 .5]);
    h12 = plot(d,ATXC_J_S_D_NP,':s','color',[0.8 0.4 0],'markerfacecolor',[0.8 0.4 0]);
...
elseif z == 6
    ...
    subplot(3,2,2)
    hold on
    h1 = plot(d,ATXC_A_S_Control,'-o','color',[0 0 0],'markerfacecolor',[0 0 0]);
    h2 = plot(d,ATXC_A_S_NO3,'-x','color',[0.9 0.6 0],'markerfacecolor',[0.9 0.6 0]);
    h3 = plot(d,ATXC_A_S_NH4,'-+','color',[0.35 0.7 0.9],'markerfacecolor',[0.35 0.7 0.9]);
    h4 = plot(d,ATXC_A_S_UREA,'-*','color',[0 0.45 0.70],'markerfacecolor',[0 0.45 0.70]);
    h5 = plot(d,ATXC_A_S_PO4,'-d','color',[0 0.6 .5],'markerfacecolor',[0 0.6 .5]);
    h6 = plot(d,ATXC_A_S_NP,'-s','color',[0.8 0.4 0],'markerfacecolor',[0.8 0.4 0]);
    ...
    subplot(3,2,4)
    hold on
    h7 = plot(d,ATXC_A_S_D_Control,':o','color',[0 0 0],'markerfacecolor',[0 0 0]);
    h8 = plot(d,ATXC_A_S_D_NO3,':x','color',[0.9 0.6 0],'markerfacecolor',[0.9 0.6 0]);
    h9 = plot(d,ATXC_A_S_D_NH4,':+','color',[0.35 0.7 0.9],'markerfacecolor',[0.35 0.7 0.9]);
    h10 = plot(d,ATXC_A_S_D_UREA,':*','color',[0 0.45 0.70],'markerfacecolor',[0 0.45 0.70]);
    h11 = plot(d,ATXC_A_S_D_PO4,':d','color',[0 0.6 .5],'markerfacecolor',[0 0.6 .5]);
    h12 = plot(d,ATXC_A_S_D_NP,':s','color',[0.8 0.4 0],'markerfacecolor',[0.8 0.4 0]);
